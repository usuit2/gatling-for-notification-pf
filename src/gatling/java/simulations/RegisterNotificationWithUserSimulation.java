...
public class RegisterNotificationWithUserSimulation extends Simulation {
    ...
    ScenarioBuilder sb = scenario("notification-pf-perfornance-test-with-user")
